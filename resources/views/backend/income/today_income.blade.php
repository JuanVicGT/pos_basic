...
@section('admin')
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Ingresos de hoy</h4>
                    </div>
                </div>
            </div>
            ...
            @php
                $date = date('d-m-Y');
                $income = App\Models\Income::where('date', $date)->sum('amount');
            @endphp
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="header-title"> Ingresos de hoy</h4>
                            <h4 style="color:white; font-size: 30px;" align="center"> Total : Q. {{ $income }}</h4>
