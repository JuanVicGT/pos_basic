                            ...
                            <ol class="breadcrumb m-0">
                                <h4>
                                    ...
                                    <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i
                                            class="fas fa-list"></i>Lista de asistencias</a>
                                </h4>
                            </ol>
                        </div>
                    </div>
                                ...
                                <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" class="text-center" style="vertical-align: middle">Nombre
                                            </th>
                                            <th colspan="3" class="text-center" style="vertical-align: middle">Status
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th class="text-center btn leave_all"
                                                style="display: table-cell;background-color:#114190">Fuera</th>
